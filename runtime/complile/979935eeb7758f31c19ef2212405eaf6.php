...
<body
  class="archive post-type-archive post-type-archive-product theme-neve woocommerce-shop woocommerce woocommerce-page woocommerce-no-js mega-menu-primary  nv-blog-grid nv-sidebar-full-width menu_sidebar_slide_left elementor-default elementor-kit-121"
  id="neve_body">
        ...
        <div class="row">
          <div class="nv-index-posts nv-shop col">
            <div class="nv-bc-count-wrap">
              <nav class="woocommerce-breadcrumb"><a href="">Home</a><span class="nv-breadcrumb-delimiter">\</span>Shop
              </nav>
              <p class="woocommerce-result-count">
                Showing {page:current}&ndash;{page:count} of {page:rows} results</p>
            </div>
...
<form class="woocommerce-ordering" method="get">
	...
	<input type="hidden" name="paged" value="1" />
            ...
            <header class="woocommerce-products-header">
              ...
              <div class="page-description">
                <h1>{sort:name}</h1>
                <p>{sort:def1 decode=1}</p>
              </div>
            </header>
            <div class="woocommerce-notices-wrapper"></div>
            <ul class="products columns-4">

              {pboot:list num=24 order=date}
              <li
            ...
            <nav class="woocommerce-pagination">
              <ul class='page-numbers'>
                <li><a class="prev page-numbers" href="{page:pre}">&larr;</a></li>
                {page:numbar}
                <li><a class="next page-numbers" href="{page:next}">&rarr;</a></li>
              </ul>
            </nav>
          </div>
        </div>
  ...
  <script type='text/javascript' id='wc-add-to-cart-js-extra'>
    /* <![CDATA[ */
    var wc_add_to_cart_params = { "ajax_url": "\/wp-admin\/admin-ajax.php", "wc_ajax_url": "\/?wc-ajax=%%endpoint%%&elementor_page_id=0", "i18n_view_cart": "View cart", "cart_url": "https:\/\/www.servolines.com\/cart\/", "is_cart": "", "cart_redirect_after_add": "no" };
    /* ]]> */
  </script>
  ...
  <script type='text/javascript' id='wc-cart-fragments-js-extra'>
    /* <![CDATA[ */
    var wc_cart_fragments_params = { "ajax_url": "\/wp-admin\/admin-ajax.php", "wc_ajax_url": "\/?wc-ajax=%%endpoint%%&elementor_page_id=0", "cart_hash_key": "wc_cart_hash_385e5f29dc4e18c1c3d34876d804eba8-en", "fragment_name": "wc_fragments_385e5f29dc4e18c1c3d34876d804eba8", "request_timeout": "5000" };
    /* ]]> */
  </script>
  <script type='text/javascript'
