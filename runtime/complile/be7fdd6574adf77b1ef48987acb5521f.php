	  	   	   ...
	  	   	   <form action="<?php echo \core\basic\Url::get('/admin/Config/index');?>" method="post" class="layui-form">
	                     ...
	                     <div class="layui-input-inline">
	                     	 <select name="upgrade_branch">
				             	<option value="3.X" <?php if ($this->getVar('branch')=='3.X') {?>selected<?php } ?>>3.X 稳定版</option>
				             	<option value="3.X.dev" <?php if ($this->getVar('branch')=='3.X.dev') {?>selected<?php } ?> >3.X 测试版</option>
				             </select>
	                     </div>
	                </div>
