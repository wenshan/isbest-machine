...
<div class="layui-body">
	  ...
	  <div class="layui-tab-content">
	  	   <div class="layui-tab-item layui-show">
	  	    ...
	  	    <div class="layui-tab-item">
	   			<form action="<?php echo \core\basic\Url::get('/admin/MemberField/add');?>" method="post" class="layui-form">
					<input type="hidden" name="formcheck" value="<?php echo $this->getVar('formcheck');?>" > 
	...
	<div class="layui-tab layui-tab-brief" lay-filter="tab">
	  ...
	  <div class="layui-tab-content">
	  	<div class="layui-tab-item layui-show">
	  		<form action="<?php echo \core\basic\Url::get('/admin/MemberField/mod/id/'.get('id').'');?><?php echo $this->getVar('backurl');?>" method="post" class="layui-form">
	  			<input type="hidden" name="formcheck" value="<?php echo $this->getVar('formcheck');?>" > 
                <div class="layui-form-item">
                     <label class="layui-form-label">字段描述</label>
                     <div class="layui-input-block">
                ...
                <div class="layui-form-item">
                     <label class="layui-form-label">是否启用</label>
                     <div class="layui-input-block">
                     	<input type="radio" name="status" value="1" title="启用" <?php if ($this->getVar('field')->status==1) {?>checked<?php } ?>>
						<input type="radio" name="status" value="0" title="禁用" <?php if ($this->getVar('field')->status==0) {?>checked<?php } ?>>
                     </div>
                </div>
