...
<div class="layui-body">
	  	   ...
	  	   <div class="layui-tab-item layui-show">
	                ...
	                <tbody>
	                    ...
	                    <tr>
	                    	...
	                    	<td><?php echo $value->lscore; ?></td>
	                    	<td><?php echo $value->uscore; ?></td>
	                        <td>
	  	    ...
	  	    <div class="layui-tab-item">
	   			<form action="<?php echo \core\basic\Url::get('/admin/MemberGroup/add');?>" method="post" class="layui-form">
					<input type="hidden" name="formcheck" value="<?php echo $this->getVar('formcheck');?>" > 
	...
	<div class="layui-tab layui-tab-brief" lay-filter="tab">
	  ...
	  <div class="layui-tab-content">
	  	<div class="layui-tab-item layui-show">
	  		<form action="<?php echo \core\basic\Url::get('/admin/MemberGroup/mod/id/'.get('id').'');?><?php echo $this->getVar('backurl');?>" method="post" class="layui-form">
	  			<input type="hidden" name="formcheck" value="<?php echo $this->getVar('formcheck');?>" > 
                
                <div class="layui-form-item">
                     <label class="layui-form-label">等级编号</label>
                     <div class="layui-input-block">
                     	<input type="text" name="gcode" value="<?php echo @$this->getVar('group')->gcode;?>" required lay-verify="required"  placeholder="请输入等级编号" class="layui-input">
                     </div>
                </div>
                ...
                <div class="layui-form-item">
                     <label class="layui-form-label">等级名称</label>
                     <div class="layui-input-block">
                     	<input type="text" name="gname" value="<?php echo @$this->getVar('group')->gname;?>" required lay-verify="required"  placeholder="请输入等级名称" class="layui-input">
                     </div>
                </div>
                ...
                <div class="layui-form-item">
                     <label class="layui-form-label">等级描述</label>
                     <div class="layui-input-block">
                     	<input type="text" name="description" value="<?php echo @$this->getVar('group')->description;?>" placeholder="请输入等级描述" class="layui-input">
                     </div>
                </div>
                ...
                <div class="layui-form-item">
                     <label class="layui-form-label">是否启用</label>
                     <div class="layui-input-block">
                     	<input type="radio" name="status" value="1" <?php if ($this->getVar('group')->status==1) {?>checked<?php } ?> title="启用" checked>
						<input type="radio" name="status" value="0" <?php if ($this->getVar('group')->status==0) {?>checked<?php } ?> title="禁用">
                     </div>
                </div>
                ...
                <div class="layui-form-item">
                     <label class="layui-form-label">积分下限</label>
                     <div class="layui-input-block">
                     	<input type="text" name="lscore" value="<?php echo @$this->getVar('group')->lscore;?>" maxlength="10"  required lay-verify="required" class="layui-input">
                     </div>
                </div>
                ...
                <div class="layui-form-item">
                     <label class="layui-form-label">积分上限</label>
                     <div class="layui-input-block">
                     	<input type="text" name="uscore" value="<?php echo @$this->getVar('group')->uscore;?>" maxlength="10"  required lay-verify="required" class="layui-input">
                     </div>
                </div>
