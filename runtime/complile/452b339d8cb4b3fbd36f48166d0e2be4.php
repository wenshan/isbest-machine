					  ...
					  <div class="layui-tab-content">
					    ...
					    <div class="layui-tab-item">
			                ...
			                <div class="layui-form-item">
			                     ...
			                     <div class="layui-input-block">
	                             <script type="text/plain" id="editor" name="def1" style="width:100%;height:140px;"></script>
			                     </div>
			                </div>
				    ...
				    <div class="layui-tab-item">
				    	<div class="layui-form-item">
		                 ...
		                 <div class="layui-form-item">
		                     <label class="layui-form-label">栏目描述1</label>
		                     <div class="layui-input-block">
		                     <script type="text/plain" id="editor" name="def1" style="width:100%;height:140px;"><?php echo decode_string($this->getVar('sort')->def1);?></script>
		                     </div>
		                </div>
...
<?php return array (
  ...
  2 => '/www/wwwroot/isbest-machine.com/apps/admin/view/default/common/ueditor.html',
); ?>