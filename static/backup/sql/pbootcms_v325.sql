...
('weixin_secret','','2','255','微信SECRET'),
('message_send_mail','1','1','255','留言发送邮件开关'),
('message_send_to','','1','255','留言发送到邮箱'),
('api_open','0','2','255','API开关'),
('api_auth','1','2','255','API强制认证'),
('api_appid','','2','255','API认证用户'),
('api_secret','','2','255','API认证密钥'),
('baidu_zz_token','','2','255','百度站长密钥'),
('baidu_xzh_appid','','2','255','熊掌号appid'),
('baidu_xzh_token','','2','255','熊掌号token'),
('wap_domain','','2','255','手机绑定域名'),
('gzip','0','2','255','GZIP压缩'),
('content_tags_replace_num','','2','255','内容关键字替换次数'),
('smtp_username_test','','2','255','测试邮箱'),
('form_send_mail','0','2','255','表单发送邮件'),
('baidu_xzh_type','0','2','255','熊掌号推送类型'),
('watermark_open','0','2','255','水印开关'),
('watermark_text','PbootCMS','2','255','水印文本'),
('watermark_text_font','','2','255','水印文本字体'),
('watermark_text_size','20','2','255','水印文本字号'),
('watermark_text_color','100,100,100','2','255','水印文本字体颜色'),
('watermark_pic','/static/images/logo.png','2','255','水印图片'),
('watermark_position','4','2','255','水印位置'),
('message_verify','1','2','255','留言审核'),
('form_check_code','0','2','255','表单验证码'),
('lock_count','5','2','255','登陆锁定阈值'),
('lock_time','900','2','255','登录锁定时间'),
('url_rule_type','3','2','255','路径类型'),
('message_status','1','2','255','留言开关'),
('form_status','1','2','255','表单开关'),
('tpl_html_dir','html','2','255','模板HTML目录'),
('ip_deny','','2','255','IP黑名单'),
('ip_allow','','2','255','IP白名单'),
('url_index_404','0','2','255','跳转404'),
('use_polyfill','0','2','255','是否使用PolyFill');
